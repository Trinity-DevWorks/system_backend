...
readonly class CompanySettingResponseData
{
    ...
    public function __construct(
        ...
        public string $taxPriceMode,
        public bool $allowNegativeStock,
        public string $inventoryCostingMethod,
    ...
    public static function fromModel(CompanySetting $settings): self
    {
        ...
        return new self(
            ...
            taxPriceMode: $settings->tax_price_mode->value,
            allowNegativeStock: (bool) $settings->allow_negative_stock,
            inventoryCostingMethod: $settings->inventory_costing_method->value,
    ...
    public function toArray(): array
    {
        return [
            ...
            'tax_price_mode' => $this->taxPriceMode,
            'allow_negative_stock' => $this->allowNegativeStock,
            'inventory_costing_method' => $this->inventoryCostingMethod,
