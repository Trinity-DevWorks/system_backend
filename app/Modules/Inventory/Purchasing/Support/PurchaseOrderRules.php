...
final class PurchaseOrderRules
{
    ...
    {
        if ($order->status === PurchaseOrderStatus::Sent || $order->sent_at !== null) {
            abort(422, 'Purchase order is already marked as sent.', ['X-Error-Code' => 'PURCHASE_ORDER_ALREADY_SENT']);
        }
