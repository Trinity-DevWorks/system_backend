...
readonly class OpeningStockLineResponseData
{
    public static function fromModel(OpeningStockLine $line): array
    {
        $line->loadMissing([
        ...
        return [
            'id' => $line->id,
            'opening_stock_id' => $line->opening_stock_id,
    ...
    /**
     * @param  Collection<int, OpeningStockLine>  $lines
     * @return array<int, array<string, mixed>>
     */
    public static function collectionToArray(Collection $lines): array
    {
        return $lines
            ->map(fn (OpeningStockLine $line): array => self::fromModel($line))
            ->values()
            ->all();
    }
