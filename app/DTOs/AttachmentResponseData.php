...
readonly class AttachmentResponseData
{
    ...
    public static function fromModel(Attachment $attachment, string $downloadUrl, string $viewUrl): self
    {
        return new self(
            ...
            checksumAlgo: $attachment->checksum_algo,
            ...
            processingStatus: $attachment->processing_status->value,
            scanStatus: $attachment->scan_status->value,
    ...
    public function toArray(): array
    {
        return [
            ...
            'checksum_algo' => $this->checksumAlgo,
