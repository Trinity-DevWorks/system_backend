...
- `PURCHASE_INVOICE_NOT_DRAFT` (HTTP 422)
- `PURCHASE_INVOICE_NO_LINES` (HTTP 422)
- `PURCHASE_INVOICE_SUPPLIER_INACTIVE` (HTTP 422)
- `PURCHASE_INVOICE_CURRENCY_INACTIVE` (HTTP 422)
- `PURCHASE_INVOICE_ITEM_INACTIVE` (HTTP 422)
- `PURCHASE_INVOICE_ITEM_NOT_PURCHASABLE` (HTTP 422)
- `PURCHASE_INVOICE_ITEM_REQUIRED` (HTTP 422)
- `PURCHASE_INVOICE_DUPLICATE_ITEM` (HTTP 422)
- `PURCHASE_INVOICE_LINE_INVALID_QUANTITY` (HTTP 422)
- `PURCHASE_INVOICE_ITEM_UOM_MISMATCH` (HTTP 422)
- `PURCHASE_INVOICE_LINE_INVALID_BASE_QUANTITY` (HTTP 422)
- `PURCHASE_INVOICE_UNIT_PRICE_REQUIRED` (HTTP 422)
